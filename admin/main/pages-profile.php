            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li> <a class="waves-effect waves-dark" href="Parametre Actualité.php" aria-expanded="false"><i class="fa fa-smile-o"></i><span class="hide-menu">Parametre Actualité</span></a>
                        </li>
