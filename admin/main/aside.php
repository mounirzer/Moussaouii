   ...
   <ul id="sidebarnav">
                        ...
                        <li> <a class="waves-effect waves-dark" href="ajouter article.php" aria-expanded="false"><i class="fa fa-user-circle-o"></i><span class="hide-menu">Ajouter Article</span></a>
                        </li>
                        ...
                        <li> <a class="waves-effect waves-dark" href="paramaitre actualite.php" aria-expanded="false"><i class="fa fa-smile-o"></i><span class="hide-menu">Parametre Actualité</span></a>
                        </li>
