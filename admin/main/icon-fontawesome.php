...
<head>
    ...
    <title>Admin|Parametre Article</title>
    <!-- Bootstrap Core CSS -->
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li> <a class="waves-effect waves-dark" href="paramaitre actualité.php" aria-expanded="false"><i class="fa fa-smile-o"></i><span class="hide-menu">Parametre Actualité</span></a>
                        </li>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Les Actualités</h4>
