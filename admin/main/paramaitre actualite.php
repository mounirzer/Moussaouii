...
<head>
    ...
    <title>Admin|Parametre Actualité</title>
    <!-- Bootstrap Core CSS -->
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h3 class="text-themecolor">Parametre Actualité</h3>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Accueil</a></li>
                            <li class="breadcrumb-item active">Parametre Actualité</li>
                        </ol>
                    </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">actualite</h4>
                                      ...
                                      <div class="form-group">
                                        ...
                                        <div class="col-sm-12">
                                            <select class="form-control form-control-line">
                                                ...
                                                <option>date importante </option>
                                                <option>informations imprtantes </option>
                                                
                                            </select>
                                        </div>
<br><br>
                                    <div class="form-group">
                                        <label class="col-md-12">nouveauté</label>
                                        <div class="col-md-12">
                                            <input type="text" placeholder="QUOI DE NEUF " class="form-control form-control-line">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <textarea rows="10" class="form-control form-control-line" placeholder="EXPRIMEZ-VOUS"></textarea>
                                        </div>
                                    </div>
                                       <div class="form-group">
                                        <label class="col-md-12">date</label>
                                        <div class="col-md-12">
                                            <input type="text" placeholder="jj/MM/AAAA " class="form-control form-control-line">
                                        </div>
                                    </div>
            ...
            <!-- ============================================================== -->
            <footer>CSMI|MOUSSAOUI BOUBAKER </footer>
            <!-- End footer -->
            <!-- ============================================================== -->
        </div>
        <!-- ============================================================== -->
