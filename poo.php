...
$sql="SELECT * FROM support where type!='article' and module='poo' ";
        ...
        <div class="row">
          <div class="col-lg-12">
            <ul id="portfolio-flters">
              <li data-filter=".filter-active"><a href="document.php">All</a></li>
              ...
              <li data-filter=".filter-web"><a href="SIAD.php">systeme informatique a l’aide à la decision</a></li>
            </ul>
          </div>
        </div>
